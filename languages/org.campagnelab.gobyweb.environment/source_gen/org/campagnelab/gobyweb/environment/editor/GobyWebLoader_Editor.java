...
public class GobyWebLoader_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_7tgov6_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createConstant_7tgov6_a0(editorContext, node));
    editorCell.addEditorCell(this.createConstant_7tgov6_b0(editorContext, node));
