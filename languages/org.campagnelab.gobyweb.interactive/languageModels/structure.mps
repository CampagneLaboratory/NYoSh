...
<model modelUID="r:29480130-ace9-4987-af0f-a6efca1c6495(org.campagnelab.gobyweb.interactive.structure)" version="31">
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2465489689644454140" nodeInfo="ig">
    ...
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="2995632242847956813" nodeInfo="ig">
      ...
      <link role="target" roleId="tpce.1071599976176" targetNodeId="2995632242847956675" resolveInfo="InputSlotValueRef" />
    </node>
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="606449909792985260" nodeInfo="ig">
    ...
    <property name="virtualPackage" nameId="tpck.1193676396447" value="tools.execution" />
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="6506431596944968499" resolveInfo="InputOptionValue" />
    <node role="linkDeclaration" roleId="tpce.1071489727083" type="tpce.LinkDeclaration" typeId="tpce.1071489288298" id="3927327347527485517" nodeInfo="ig">
      <property name="metaClass" nameId="tpce.1071599937831" value="aggregation" />
    ...
    <node role="propertyDeclaration" roleId="tpce.1071489727084" type="tpce.PropertyDeclaration" typeId="tpce.1071489288299" id="3659415948326730563" nodeInfo="ig">
      <property name="name" nameId="tpck.1169194664001" value="allowedCategories" />
      <link role="dataType" roleId="tpce.1082985295845" targetNodeId="tpck.1082983041843" resolveInfo="string" />
    </node>
  </root>
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="2995632242847956675" nodeInfo="ig">
    <property name="virtualPackage" nameId="tpck.1193676396447" value="tools.execution" />
    <property name="name" nameId="tpck.1169194664001" value="InputSlotValueRef" />
    <link role="extends" roleId="tpce.1071489389519" targetNodeId="tpck.1133920641626" resolveInfo="BaseConcept" />
