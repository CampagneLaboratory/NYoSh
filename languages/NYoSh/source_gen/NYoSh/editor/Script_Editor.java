...
public class Script_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_udqu28_e0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_udqu28_a4a(editorContext, node));
    return editorCell;
  }

  private EditorCell createRefNode_udqu28_a4a(EditorContext editorContext, SNode node) {
