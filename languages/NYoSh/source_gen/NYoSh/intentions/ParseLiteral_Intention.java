...
public class ParseLiteral_Intention implements IntentionFactory {
  ...
  public class IntentionImplementation implements IntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      PatternMatcher matcher = PatternMatcher.matchOperators(new String[]{";", "&&", "||", "|"});
        ...
        if (component.isPattern()) {
          ...
          switch (index) {
            ...
            case 2:
              ...
              break;
            case 3:
              binaryOperator = SConceptOperations.createNewNode("NYoSh.structure.PipeCommandOperator", null);
              break;
            default:
          ...
          SNode gstringCommand = _quotation_createNode_m4ussu_a0a0a1a7a0();
  ...
  private static SNode _quotation_createNode_m4ussu_a0a0a1a7a0() {
