...
public class StructureAspectDescriptor implements jetbrains.mps.smodel.runtime.StructureAspectDescriptor {
  ...
  public ConceptDescriptor getDescriptor(String conceptFqName) {
    switch (Arrays.binarySearch(stringSwitchCases_1htk8d_a0a0b, conceptFqName)) {
      ...
      case 2:
        return new ConceptDescriptorBuilder("NYoSh.structure.BinaryCommandOperator").super_("NYoSh.structure.AbstractCommand").parents("NYoSh.structure.AbstractCommand").children(new String[]{"leftCommand", "rightCommand"}, new boolean[]{false, false}).alias("<?>", "").create();
      case 3:
