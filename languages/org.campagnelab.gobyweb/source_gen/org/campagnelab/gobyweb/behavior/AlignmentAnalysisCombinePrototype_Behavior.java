...
public class AlignmentAnalysisCombinePrototype_Behavior {
  public static void init(SNode thisNode) {
    SPropertyOperations.set(thisNode, "header", "analysis entry point");
    SPropertyOperations.set(thisNode, "implementationMethodName", "combine");
  }

  public static List<SNode> virtual_parameters_2829258213786778419(SNode thisNode) {
    List<SNode> parameters = new ArrayList<SNode>();
    ListSequence.fromList(parameters).addElement(_quotation_createNode_obmdaf_a0a1a0());
    ListSequence.fromList(parameters).addElement(_quotation_createNode_obmdaf_a0a2a0());
    return parameters;
  }

  private static SNode _quotation_createNode_obmdaf_a0a1a0() {
    ...
    SNodeAccessUtil.setProperty(quotedNode_1, "name", "resultsFile");
  ...
  private static SNode _quotation_createNode_obmdaf_a0a2a0() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ParameterDeclaration", null, null, false);
    SNodeAccessUtil.setProperty(quotedNode_1, "name", "partResultFiles");
