...
public class ArtifactInstallEntryPointPrototype_Behavior {
  ...
  public static List<SNode> virtual_parameters_2829258213786778419(SNode thisNode) {
    ...
    ListSequence.fromList(parameters).addElement(_quotation_createNode_tvkj4r_a0a1a0());
    ListSequence.fromList(parameters).addElement(_quotation_createNode_tvkj4r_a0a2a0());
    return parameters;
  }

  private static SNode _quotation_createNode_tvkj4r_a0a1a0() {
    ...
    SNodeAccessUtil.setProperty(quotedNode_1, "name", "id");
  ...
  private static SNode _quotation_createNode_tvkj4r_a0a2a0() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
    SNode quotedNode_2 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ParameterDeclaration", null, null, false);
    SNodeAccessUtil.setProperty(quotedNode_1, "name", "installation_path");
    quotedNode_2 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.StringType", null, null, false);
    quotedNode_1.addChild("type", quotedNode_2);
    return quotedNode_1;
  }
