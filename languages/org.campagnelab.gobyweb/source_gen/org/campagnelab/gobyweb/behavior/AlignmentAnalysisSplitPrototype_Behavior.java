...
public class AlignmentAnalysisSplitPrototype_Behavior {
  public static void init(SNode thisNode) {
    SPropertyOperations.set(thisNode, "header", "analysis entry point");
    SPropertyOperations.set(thisNode, "implementationMethodName", "split");
  }

  public static List<SNode> virtual_parameters_2829258213786778419(SNode thisNode) {
    List<SNode> parameters = new ArrayList<SNode>();
    ListSequence.fromList(parameters).addElement(_quotation_createNode_exgcj9_a0a1a0());
    ListSequence.fromList(parameters).addElement(_quotation_createNode_exgcj9_a0a2a0());
    ListSequence.fromList(parameters).addElement(_quotation_createNode_exgcj9_a0a3a0());
    return parameters;
  }

  private static SNode _quotation_createNode_exgcj9_a0a1a0() {
    ...
    SNodeAccessUtil.setProperty(quotedNode_1, "name", "numOfParts");
  ...
  private static SNode _quotation_createNode_exgcj9_a0a2a0() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
    SNode quotedNode_2 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ParameterDeclaration", null, null, false);
    SNodeAccessUtil.setProperty(quotedNode_1, "name", "splicingPlanResult");
  ...
  private static SNode _quotation_createNode_exgcj9_a0a3a0() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNode quotedNode_1 = null;
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
    quotedNode_1 = SModelUtil_new.instantiateConceptDeclaration("jetbrains.mps.baseLanguage.structure.ParameterDeclaration", null, null, false);
    SNodeAccessUtil.setProperty(quotedNode_1, "name", "parts");
