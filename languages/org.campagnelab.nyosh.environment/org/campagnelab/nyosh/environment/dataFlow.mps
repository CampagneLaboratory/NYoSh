...
<model modelUID="r:8468768d-f234-4603-b4fb-b522096568c3(org.campagnelab.nyosh.environment.dataFlow)">
  ...
  <root type="tp41.DataFlowBuilderDeclaration" typeId="tp41.1206442055221" id="2328891098877350406" nodeInfo="ng">
    ...
    <node role="builderBlock" roleId="tp41.1206442812839" type="tp41.BuilderBlock" typeId="tp41.1206442659665" id="2328891098877350407" nodeInfo="nn">
      <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2328891098877350408" nodeInfo="sn">
        <node role="statement" roleId="tpee.1068581517665" type="tp41.EmitReadStatement" typeId="tp41.1206443823146" id="2328891098877357833" nodeInfo="nn">
          <node role="variable" roleId="tp41.1206444629799" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2328891098877358353" nodeInfo="nn">
            <node role="operand" roleId="tpee.1197027771414" type="tp41.NodeParameter" typeId="tp41.1206442747519" id="2328891098877357951" nodeInfo="nn" />
            <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="2328891098877361668" nodeInfo="nn">
  ...
  <root type="tp41.DataFlowBuilderDeclaration" typeId="tp41.1206442055221" id="2328891098878807936" nodeInfo="ng">
    ...
    <node role="builderBlock" roleId="tp41.1206442812839" type="tp41.BuilderBlock" typeId="tp41.1206442659665" id="2328891098878807937" nodeInfo="nn">
      <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="2328891098878807938" nodeInfo="sn">
        <node role="statement" roleId="tpee.1068581517665" type="tp41.EmitReadStatement" typeId="tp41.1206443823146" id="2328891098878808001" nodeInfo="nn">
          <node role="variable" roleId="tp41.1206444629799" type="tpee.DotExpression" typeId="tpee.1197027756228" id="2328891098878808421" nodeInfo="nn">
            <node role="operand" roleId="tpee.1197027771414" type="tp41.NodeParameter" typeId="tp41.1206442747519" id="2328891098878808019" nodeInfo="nn" />
            <node role="operation" roleId="tpee.1197027833540" type="tp25.SLinkAccess" typeId="tp25.1138056143562" id="2328891098878815020" nodeInfo="nn">
              <link role="link" roleId="tp25.1138056516764" targetNodeId="6pk0.224223098170517510" />
            </node>
          </node>
        </node>
