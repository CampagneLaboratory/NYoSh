...
<model modelUID="r:df9645c2-d2fa-41cb-a718-044a287b0626(org.campagnelab.clusterConfig.structure)" version="3">
  ...
  <root type="tpce.ConceptDeclaration" typeId="tpce.1071489090640" id="664989078347184634" nodeInfo="ig">
    ...
    <node role="propertyDeclaration" roleId="tpce.1071489727084" type="tpce.PropertyDeclaration" typeId="tpce.1071489288299" id="8730366339363530155" nodeInfo="ig">
      <property name="name" nameId="tpck.1169194664001" value="connectionChecked" />
      <link role="dataType" roleId="tpce.1082985295845" targetNodeId="tpck.1082983657063" resolveInfo="boolean" />
    </node>
    <node role="propertyDeclaration" roleId="tpce.1071489727084" type="tpce.PropertyDeclaration" typeId="tpce.1071489288299" id="8730366339363382117" nodeInfo="ig">
